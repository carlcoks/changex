...
<template>
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
            d="M14.0625 11.875C14.4077 11.875 14.6875 11.5952 14.6875 11.25C14.6875 10.9048 14.4077 10.625 14.0625 10.625C13.7173 10.625 13.4375 10.9048 13.4375 11.25C13.4375 11.5952 13.7173 11.875 14.0625 11.875Z"
            :fill="props.stroke"
        />
    </svg>
</template>
